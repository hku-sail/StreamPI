...
JAX_DEBUG_NOWAIT=1 XLA_PYTHON_CLIENT_MEM_FRACTION=0.9 python scripts/train.py pi05_calvin_stream5 --exp-name=pi05_stream5_calvin --resume --batch-size 256 --fsdp-devices=8
